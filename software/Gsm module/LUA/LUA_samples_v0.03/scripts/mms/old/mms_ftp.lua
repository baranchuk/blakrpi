  ...
  while (count < test_mms_send_count) do
    ...
    if (test_mms_send) then      
      ...
      if (send_suc and send_mms_to_self) then
        ...
        local location = mms_receive_wap_push_rpt(300000);
...
print(rsp);
print("tested_count: ",count, "\r\nmms send_suc_count: ", send_suc_count, "\r\nmms recv_suc_count: ", recv_suc_count,"\r\n"); 
print("ftp put_suc_count: ", put_suc_count, "\r\nftp get_suc_count: ", get_suc_count,"\r\n"); 
print("---------------------finished test---------------------\r\n");