...
error_code = smtps.set_server("smtp.gmail.com", 465, SERVER_TYPE_SMTPS);
...
error_code = smtps.set_auth("jin.song.test", "songjintest123456");
print("smtps.set_auth(), error_code = ", error_code, "\r\n");



error_code = smtps.set_from("<jin.song.test@gmail.com>");
